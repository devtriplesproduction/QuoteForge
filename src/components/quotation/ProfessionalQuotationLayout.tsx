...
export default function ProfessionalQuotationDocument({
    ...
    return (
        ...
        >
            <div className="px-8 sm:px-14 pt-10 pb-14 flex flex-col h-full">
                {/* Top Header */}
                    ...
                    <div className="flex items-start gap-3 min-w-0">
                        {brandKit?.logo_url ? (
                            <img
                                src={brandKit.logo_url}
                                alt="Logo"
                                className="h-10 w-10 object-contain border border-gray-300 shrink-0"
                            />
                        ) : (
                            <div className="h-10 w-10 border border-gray-300 flex items-center justify-center shrink-0">
                                <svg viewBox="0 0 24 24" className="h-5 w-5 text-gray-700">
                                    <rect x="3" y="4" width="18" height="2" fill="currentColor" />
                                    <rect x="3" y="11" width="12" height="2" fill="currentColor" />
                                    <rect x="3" y="18" width="18" height="2" fill="currentColor" />
                ...
                <div className="border border-gray-200 mb-10">
                    ...
                    {clientRows.map((row, idx) => (
                        ...
                        <div
                            key={row.label}
                            className={`flex flex-wrap sm:flex-nowrap px-5 py-3 gap-1 sm:gap-0 ${idx !== clientRows.length - 1 ? "border-b border-gray-200" : ""
                                }`}
                        >
                            <span className="w-full sm:w-40 shrink-0 text-[10px] tracking-[0.15em] text-gray-400">
                                {row.label.toUpperCase()}
                            </span>
                            <span className="text-[12px] text-gray-800 break-words min-w-0">{row.value}</span>
                        </div>
                ...
                <div className="mb-8">
                    ...
                    <p className="text-[12px] leading-[1.9] text-gray-600 whitespace-pre-wrap break-words">
                        {projectOverview}
                    </p>
                </div>
                            ...
                            return (
                                ...
                                >
                                    ...
                                    <div className="flex-1 min-w-0">
                                        <h3 className="text-[12px] font-bold text-gray-900 tracking-wide mb-3 break-words">
                                            {s.service_name?.toUpperCase()}
                                        </h3>
                ...
                <div className="px-8 sm:px-14 pt-10 pb-14 flex flex-col h-full">
                    ...
                    {quotation.payment_terms_text ? (
                        <div className="mb-8">
                            ...
                            <RichTextDisplay
                                content={quotation.payment_terms_text}
                                className="text-[11px] text-gray-600 leading-[1.9] break-words"
                            />
                        </div>
                    ) : null}
                    ...
                    <div className="border border-gray-200 mb-8">
                        ...
                        <div className="grid grid-cols-1 sm:grid-cols-2 gap-x-8 gap-y-6 px-5 py-4">
                            <div>
                                <h4 className="text-[11px] font-bold text-gray-900 tracking-wide mb-2">
                                    FIRST 3 MONTHS — INCLUDED
                                </h4>
                    ...
                    <div className="border border-gray-200 mb-8 overflow-x-auto">
                        <div className="min-w-[520px]">
                            ...
                            {(serviceBlocks && serviceBlocks.length > 0
                                ...
                                >
                                    <div className="px-4 py-3 text-[11px] font-bold text-gray-900 break-words">
                                        {s.service_name}
                                    </div>
                                    <div className="px-4 py-3 text-[11px] text-gray-500">
                                        <RichTextDisplay
                        ...
                        return (
                            <div className="flex justify-end mb-10">
                                <div className="w-full sm:max-w-xs space-y-2">
                                    ...
                                    <div className="flex justify-between gap-2 border-t border-gray-900 pt-2">
                                        <span className="text-[12px] font-bold text-gray-900">
                                            Grand Total
                                        </span>
                                        <span className="text-[14px] font-bold text-gray-900">
                    ...
                    <div className="border-t border-gray-100 pt-6 grid grid-cols-1 sm:grid-cols-3 gap-8">
                        <div className="min-w-0">
                            ...
                            <div className="text-[11px] text-gray-500 space-y-0.5 break-words">
                                <p>{brandKit?.phone || "+91 00000 00000"}</p>
                                <p>{brandKit?.email || "info@triplesproduction.com"}</p>
                                <p>{brandKit?.website || "https://triplesproduction.com/"}</p>
                            </div>
