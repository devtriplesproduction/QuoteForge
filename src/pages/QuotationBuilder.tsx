...
//             <div ref={rightColumnRef} className="w-full lg:w-[500px] lg:max-w-[500px] xl:w-[500px] shrink-0 space-y-6">              <Card className="relative rounded-2xl border-2 shadow-sm hover:shadow-xl transition-shadow duration-300 overflow-hidden">
...
// import Step2PaymentSchedule from "@/components/quotation/Step2PaymentSchedule";
